...
- Current, last-seen, moved, removed, and reclassified states remain distinct and retain provenance.
...
Until these checks are recorded, the features are implemented and automation-verified but are not presented as physically accepted or release-certified.
